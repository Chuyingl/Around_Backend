...
const (
	...
	POST_INDEX          = "post"
	POST_TYPE           = "post"
	ES_URL              = "http://35.237.208.118:9200"
	BUCKET_NAME         = "post-images-0624"
	BIGTABLE_PROJECT_ID = "around624"
...
func saveToBigTable(p *Post, id string) error {
	...
	//one mutation represent one row
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	//	return
	//}
	//	fmt.Printf("Saved one post to BigTable: %s", p.Message)
}
